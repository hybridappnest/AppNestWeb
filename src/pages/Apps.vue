<template>
  <q-layout vie="hHh lpr fFf" className="bg-grey-11">

    <!-- 页头 -->
    <q-header className="bg-grey-12 nest-box-shadow text-dark">
      <div className="row items-center no-wrap">
        <!-- type your code here ... -->
      </div>
    </q-header>

    <!-- 页脚 -->
    <q-footer className="bg-white nest-box-shadow-up text-dark">
      <div className="row items-center no-wrap">
        <!-- type your code here ... -->
      </div>
    </q-footer>
